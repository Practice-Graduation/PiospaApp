    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bindView(OrderProductRealm cartProductItem) {
            try {
                ...
                txtPrice.setText(new StringBuilder(mContext.getString(R.string.price) + ": " + CommonUtils.formatToCurrency(cartProductItem.getPrice())));
                txtQuanlity.setText(new StringBuilder(mContext.getString(R.string.quanlity)+": "+cartProductItem.getAmount()));
